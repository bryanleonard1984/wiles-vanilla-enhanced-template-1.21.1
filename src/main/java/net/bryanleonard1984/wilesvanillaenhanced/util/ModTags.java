package net.bryanleonard1984.wilesvanillaenhanced.util;
...
public class ModTags
{
    public static class Blocks
    {
        ...
        {
            return TagKey.of(RegistryKeys.BLOCK, Identifier.of(WilesVanillaEnhanced.MOD_ID, name));
        }
    }
    ...
    public static class Items
    {
        ...
        {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of(WilesVanillaEnhanced.MOD_ID, name));
        }
    }
}
