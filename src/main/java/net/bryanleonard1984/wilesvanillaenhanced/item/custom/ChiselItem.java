package net.bryanleonard1984.wilesvanillaenhanced.item.custom;
...
public class ChiselItem extends Item
{
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type)
    {
        ...
        {
            tooltip.add(Text.translatable("tooltip.wilesvanillaenhanced.chisel.shiftdown"));
        }
        else
        {
            tooltip.add(Text.translatable("tooltip.wilesvanillaenhanced.chisel"));
        }
